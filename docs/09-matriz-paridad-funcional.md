...
**Sin decidir todavía cuál aplicar** — a la espera de la preferencia del propietario del proyecto.
...
Ninguno de estos ha fallado todavía (los archivos de prueba usados hasta ahora en este entorno son pequeños), pero **la condición que provoca el fallo en Campañas está igualmente presente en los tres**. Es un riesgo real, no solo teórico, en cuanto se usen archivos de tamaño de producción. Si se decide corregir el problema de raíz (opción 2 del punto 1: subida directa a Storage desde el cliente), el mismo patrón debería aplicarse a estos cuatro puntos a la vez, no solo a Campañas — evitaría dejar tres bombas de relojería iguales sin resolver.
