...
Ninguna fase que module estas funcionalidades (Fase 5 para H-02) cierra su checklist mientras su hallazgo correspondiente siga con Decisión "Pendiente". H-01, H-04 a H-13 (salvo H-02) ya están corregidos y no bloquean ninguna fase. H-02 sigue genuinamente pendiente de una decisión funcional del propietario del proyecto (¿la hoja "Resumen" debe filtrarse también por la campaña del export, o se mantiene tal cual?).
